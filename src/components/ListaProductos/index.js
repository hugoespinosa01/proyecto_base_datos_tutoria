        ...
        <div className="datatable-crud-demo">
            ...
            <Dialog visible={productDialog} style={{ width: '450px' }} header="Product Details" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                ...
                <div className="formgrid grid">
                    <div className="field col">
                        ...
                        <InputNumber id="price" value={product.precio} onValueChange={(e) => onInputNumberChange(e, 'precio')} mode="currency" currency="USD" locale="en-US" />
                    </div>
                    <div className="field col">
                        <label htmlFor="quantity">cantidad</label>
                        <InputNumber id="quantity" value={product.cantidad} onValueChange={(e) => onInputNumberChange(e, 'cantidad')} integeronly />
                    </div>
                </div>
            </Dialog>
            ...
            <Dialog visible={deleteProductDialog} style={{ width: '450px' }} header="Confirm" modal footer={deleteProductDialogFooter} onHide={hideDeleteProductDialog}>
                <div className="confirmation-content">
                    ...
                    {product && <span>Desea eliminar el siguiente producto :  <b>{product.nombre}</b>?</span>}
                </div>
            </Dialog>
